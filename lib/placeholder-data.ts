...
export const placeholderEvents = [
  {
    id: "1",
    title: "Atelier fitness canin en plein air — Lyon",
    location: "Parc de la Tête d'Or, Lyon",
    starts_at: "2026-09-20",
    is_past: false,
    description:
      "Une matinée pratique pour découvrir les bases du fitness canin encadrée par Marie, en petit groupe.",
  },
  {
    id: "2",
    title: "Stage préparation canicross",
    location: "Annecy",
    starts_at: "2026-10-11",
    is_past: false,
    description:
      "Stage d'une journée pour préparer physiquement votre chien à la saison de canicross.",
  },
  {
    id: "3",
    title: "Conférence \"Prévenir les blessures sportives du chien\"",
    location: "En ligne",
    starts_at: "2026-03-15",
    is_past: true,
    description:
      "Une conférence en ligne sur les signaux d'alerte et la prévention des blessures chez le chien sportif.",
  },
];
