...
export const metadata = { title: "Admin — Cours" };
...
export default async function AdminCoursPage() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-extrabold text-brand-brown">Cours</h1>
      ...
      <div className="mt-10 max-w-xl rounded-2xl bg-white p-6 shadow-sm ring-1 ring-brand-brown/5">
        <h2 className="text-base font-bold text-brand-brown">Créer un cours</h2>
