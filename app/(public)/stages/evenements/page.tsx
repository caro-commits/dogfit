...
export const metadata = {
  title: "Événements",
  description:
    "Les prochains stages, ateliers et événements de fitness canin et de technique de saut animés par Marie Démaris (DOGFIT).",
  alternates: { canonical: "/stages/evenements" },
};
  ...
  return (
    <Container className="py-16">
      ...
      <p className="mt-4 max-w-2xl text-brand-brown/70">
        Les prochains stages et ateliers ouverts aux inscriptions, ainsi que
      ...
      <p className="mt-14 max-w-2xl text-sm text-brand-brown/70">
        Découvrir le{" "}
        <Link
          href="/stages/fitness"
